...
from app_basica.forms import UserForm, InfoPerfilUsuarioForm
...
def index(request):
    return render(request,'basic_app/inicio.html')
...
def user_login(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            print('alguien intentó logearse y falló')
            print('Username: {} and password: {}'.format(username,password))
            return HttpResponse('Datalles invalidos ')
